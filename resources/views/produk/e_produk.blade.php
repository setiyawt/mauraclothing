                ...
                <div class="card pt-2">
                    <div class="card-body">
                        ...
                        <form action="{{ route('produk.update', $produk->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <h6 style="margin-top:16px">Link Produk</h6>
                            <input class="form-control" name="product_link" value='{{ $produk->product_link }}' type="text" placeholder="Link" aria-label="default input example">
