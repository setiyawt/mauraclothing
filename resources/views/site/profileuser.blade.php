    ...
    <div class="container">
        ...
        <div class="box-kat">
            <form action="/profileuser/{{auth()->user()->id}}" method="POST" enctype="multipart/form-data">
                ...
                <br>
                <input type="text" name="name" class="input-control" style="width: 100%;" value="&ensp;{{auth()->user()->name}}">
                <br>
                <h5 style="display:inline-block;">Username</h5><br>
                <input type="text" name="username" class="input-control" style="width: 100%;" value="&ensp;{{auth()->user()->username}}">
                <br>
